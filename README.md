...
3. **Стек задач (roadmap.md)** + **Сессионный контекст (sessions.md)** — задачи с глубиной вложенности в roadmap. Сессионный лог в отдельном файле. В конце сессии Claude записывает что сделано и что важного осталось (WARM-резидуал). Следующая сессия начинает не с нуля.
